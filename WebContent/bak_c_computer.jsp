					...
					<div class="inner">
						<nav class="main_menu">
							<ul>
								...
								<li class="current_page_item"><a href="#">比赛信息</a></li>
				...
				<section class="section_secondary_menu">
					<div class="inner">
						<nav class="secondary_menu">
							<ul>
								<li><a href="#">计算机</a></li>
								<li><a href="c_literature.jsp">文学</a></li>
								<li><a href="c_math.jsp">数学</a></li>
								<li><a href="c_english.jsp">英语</a></li>
							</ul>
						</nav>
					...
					<div class="main_content">
						...
						<div class="block_main_news">
							<article class="block_news_post_feature">
								<div class="f_pic">
									<a href="c_cp_lhb.html" class="general_pic_hover scale"><img
										src="images/pic_main_news_big.jpg" alt="" /></a>
								</div>
								<h4 class="title">
									<a href="c_cp_lhb.html">2019年全国高校计算机能力挑战赛</a>
								</h4>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="c_cp_wxj.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_1.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_2.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">2019年全国虚拟仪器设计大赛</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
									</div>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_3.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">2019年中国大学生计算机设计大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_4.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">2019年第十二届全国大学生信息安全竞赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_5.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post.html">第九届全国大学生计算机应用能力与信息素养大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_6.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post.html"> 第十届蓝桥杯全国软件和信息技术专业人才大赛</a><a
										href="news_post2.html"></a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_7.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">第十届全国大学生“斯维尔杯”建筑信息模型</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_8.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">浙江省首届大学生网络与信息安全竞赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_9.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">第八届海峡两岸信息服务创新大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_10.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">2019年“领航杯”江苏省信息技术应用能力比赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_11.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">2018年”创青春“全国大学生创业大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_12.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">第九届“创新杯”建筑信息模型（BIM）应用大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_13.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">第八届高等学校信息技术创新与实践大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post2.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_14.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">2019年湖北省大学生信息技术创新大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="news_post.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_15.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post2.html">第二届中国人工智能·多媒体信息识别技术大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
