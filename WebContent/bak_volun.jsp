...
<head>
<meta charset="UTF-8">
<title>BusinessNews - Our Blog Style 1</title>
					...
					<div class="main_content">
						...
						<div class="block_blog_1">
							<article class="blog_post">
								<div class="tail"></div>
								<div class="f_pic">
									<a href="volunteer1.html"><img
										src="images/pic_blog_1_1.jpg" alt="" /></a>
								</div>

								<h4 class="title">
									<a href="volunteer1.html">志愿者招募 | 广州国际纪录片节志愿者招募.</a>
								</h4>
								...
								<div class="info">
									...
									<div class="r_part">
										...
										<a href="#" class="views">650</a> <a href="#" class="comments">25</a>
									</div>
								</div>
							...
							<article class="blog_post">
								<div class="tail"></div>
								<div class="f_pic">
									<a href="volunteer2.html" class="general_pic_hover zoom"><img
										src="images/pic_blog_1_2.jpg" alt="" /></a>
								</div>

								<h4 class="title">
									<a href="volunteer2.html" target="_blank">志愿者招募 |
										2019重庆长江草莓音乐节志愿者招募.</a>
								</h4>

								<div class="info">
									<div class="date">
										<p>
											<a href="#">15 July, 2012</a>
										</p>
									</div>
									<div class="author">
										<p>
							...
							<article class="blog_post">
								<div class="tail"></div>
								<div class="f_pic">
									<a href="volunteer3.html"><img
										src="images/pic_blog_1_3.jpg" alt="" /></a>
								</div>

								<h4 class="title">
									<a href="volunteer3.html" target="_blank">志愿者招募 |
										第二届华教杯全国大学生数学竞赛宣传志愿者招募.</a>
								</h4>
							...
							<article class="blog_post">
								<div class="tail"></div>
								<div class="f_pic">
									<a href="volunteer4.html"><img
										src="images/pic_blog_1_4.jpg" alt="" /></a>
								</div>

								<h4 class="title">
									<a href="volunteer4.html"> 2019年全国高校计算机能力挑战赛宣传志愿者招募.</a>
								</h4>
