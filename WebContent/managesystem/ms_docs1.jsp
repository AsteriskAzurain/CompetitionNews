...
<script type="text/javascript">
	...
	function deleteuser(userid) {
		if (confirm("确定要删除吗？")) {
			alert("已删除。")
			window.location.replace("../bbspostdeleteaction.action?p_pid=" + userid);
		} else {
			alert("已取消。")
		}
	}
	...
	function querybyid(p_ptheme) {
		$
				.ajax({
					type : 'post',
					url : '../bbspostquerybyeneityaction.action?p_ptheme'+p_ptheme,
			...
			<div style="margin-left: 30px">
				...
				<form name="searchpost">
					<input type="button" value="添加" class="i1"
						...
						class="i1" name="search"> <input type="button" value="搜索" class="i1"
						onclick="querybyid(searchpost.search.value)">
				</form>
			</div>
