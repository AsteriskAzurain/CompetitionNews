					...
					<div class="inner">
						<nav class="main_menu">
							<ul>
								...
								<li class="current_page_item"><a href="c_computer.jsp">比赛信息</a></li>
				...
				<section class="section_secondary_menu">
					<div class="inner">
						<nav class="secondary_menu">
							<ul>
								<li><a href="c_computer.jsp">计算机</a></li>
								<li><a href="#">文学</a></li>
			...
			<div class="inner">
				<div class="general_content">
					<div class="main_content">
						...
						<p class="general_subtitle">对于当代大学生来说，在大学当中积累一定的专业竞赛经验，提高自己的专业素养是一件很重要的事。</p>
						...
						<div class="block_main_news">
							<article class="block_news_post_feature">
								<div class="f_pic">
									<a href="c_lt_fzy.html" class="general_pic_hover scale"><img
										src="images/pic_main_news_big.jpg" alt="" /></a>
								</div>
								<h4 class="title">
									<a href="c_lt_fzy.html">大型电视节目《诗·中国》同题诗征集</a><a
										href="c_lt_fzy.html"></a>
								</h4>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								<div class="f_pic">
									<a href="c_lt_ch.html" class="general_pic_hover scale_small"><img
										src="images/pic_main_news_1.jpg" alt="" /></a>
								</div>
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="c_lt_ch.html">&ldquo;清白泉&rdquo;杯全国清廉诗歌散文大赛</a><a
										href="c_lt_ch.html"></a>
								</p>
								<div class="info">
									<div class="date">
							...
							<article class="block_news_post">
								...
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post.html"><a href="news_post.html">第七届东方杯全国大学生勘探地球物理大赛
									</a>
								</p>
								<div class="info">
									<div class="date">
							...
							<article class="block_news_post">
								...
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post.html">第十九届广东大学生物理实验设计大赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								...
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post.html">2019年吉林省大学生物理学术竞赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
							...
							<article class="block_news_post">
								...
								<p class="category">&nbsp;</p>
								<p class="title">
									<a href="news_post.html">2018 年吉林省大学生物理学术竞赛</a>
								</p>
								<div class="info">
									<div class="date">
										<p>01 July, 2019</p>
